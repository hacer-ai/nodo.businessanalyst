...
st.set_page_config(
    page_title="Nodo + Business Analyst",
    page_icon="🧠",
...
st.sidebar.title("Nodo + Business Analyst")
st.sidebar.divider()
st.sidebar.markdown("Mentor Business Analyst", unsafe_allow_html=True)
st.sidebar.markdown("hacer Agent Toolkit 1.0")
st.sidebar.divider()

st.write("""<img height="120" src="https://es.nodoeafit.com/wp-content/uploads/2024/10/businessanalyst.png"/>""", unsafe_allow_html=True)
